 ...
 */
package com.appleyk.api;

import com.appleyk.constant.Constant;
import com.appleyk.utils.ObjectUtil;
...
public class R<T> implements Serializable {
     ...
     * @return boolean
     */
    public static boolean isSuccessData(@Nullable R<?> result) {
        return Optional.ofNullable(result)
            .map(x -> Objects.equals(ResultCode.SUCCESS.code, x.code) && Objects.nonNull(x.data))
            .orElse(Boolean.FALSE);
    }
